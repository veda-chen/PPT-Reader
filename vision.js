...
const MODEL = process.env.VISION_MODEL || "doubao-seed-2-0-lite-260428";
...
async function main() {
  if (!API_KEY) {
    console.error("请设置 ARK_API_KEY 环境变量或在 .env 文件中配置。");
    console.error("获取 Key: https://console.volcengine.com/ark/");
    process.exit(1);
  }
